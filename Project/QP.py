...
def story_parser(story):
    ...
    for i in range(start,len(story)):
        ...
        if fullstop_index != -1 and story[i][fullstop_index+1:fullstop_index+2] !='.' and story[i][fullstop_index+1:fullstop_index+2] !='e' \
                and story[i][fullstop_index-2:fullstop_index]!='Dr' and story[i][fullstop_index-2:fullstop_index]!='Mr'\
                and story[i][fullstop_index-2:fullstop_index]!='Ms' and len(story[i])!=2 :
            min_index=max(blank_line,fullstop_line)
            #print 'Min index is :', min_index
            #print 'Current index is :,',i
            #print 'Current index - min_index is :',i-min_index
